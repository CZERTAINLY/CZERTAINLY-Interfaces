...
class DiscoveryMetadataControllerCompileTest {
    ...
    static class Mock implements DiscoveryMetadataController {
        @Override public List<DiscoverySupportedResourceDto> listSupportedResources() { return List.of(); }
        @Override public List<BaseAttribute> listRunAttributes() { return List.of(); }
        @Override public List<BaseAttribute> listResourceAttributes(Resource resource) { return List.of(); }
    }
