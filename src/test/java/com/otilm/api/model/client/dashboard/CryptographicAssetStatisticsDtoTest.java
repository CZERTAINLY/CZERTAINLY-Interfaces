...
class CryptographicAssetStatisticsDtoTest {
    ...
    void roundTripsThroughJson() throws Exception {
        ...
        dto.setSourceCbomCount(14L);
        dto
                .setStatByType(Map
                        .of("algorithm", 1500L, "certificate", 400L, "protocol", 120L, "related-crypto-material", 105L,
                                "unclassified", 4L));
        dto.setStatByPqcVerdict(Map.of("ready", 300L, "notReady", 1700L, "unknown", 129L));
        ...
        Assertions.assertEquals(1700L, tree.get("statByPqcVerdict").get("notReady").asLong());
