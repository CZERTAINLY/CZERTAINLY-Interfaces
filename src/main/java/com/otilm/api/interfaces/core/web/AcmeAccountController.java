...
public interface AcmeAccountController extends AuthProtectedController {
    ...
    @GetMapping(path = "/acmeProfiles/{acmeProfileUuid}/acmeAccounts/{acmeAccountUuid}",
    ...
    @PatchMapping(path = "/acmeProfiles/{acmeProfileUuid}/acmeAccounts/{acmeAccountUuid}/enable",
            produces = {"application/json"})
    ...
    @PatchMapping(path = "/acmeProfiles/{acmeProfileUuid}/acmeAccounts/{acmeAccountUuid}/disable",
            produces = {"application/json"})
    @ResponseStatus(HttpStatus.NO_CONTENT)
    ...
    @PostMapping(path = "/acmeProfiles/{acmeProfileUuid}/acmeAccounts/{acmeAccountUuid}",
            produces = {"application/json"})
    @ResponseStatus(HttpStatus.NO_CONTENT)
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void bulkEnableAcmeAccount(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "ACME Account UUIDs",
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void bulkRevokeAcmeAccount(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "ACME Account UUIDs",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(
                            value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> uuids)
            throws NotFoundException;
