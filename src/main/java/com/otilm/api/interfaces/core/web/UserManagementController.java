...
public interface UserManagementController extends AuthProtectedController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Group, Certificate or Attribute definition not found",
                    content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PostMapping(consumes = {"application/json"}, produces = {"application/json"})
    ResponseEntity<UserDetailDto> createUser(@RequestBody @Valid AddUserRequestDto request)
    ...
    UserDetailDto updateUser(@Parameter(description = "User UUID") @PathVariable String userUuid,
    ...
    UserDetailDto enableUser(@Parameter(description = "User UUID") @PathVariable String userUuid)
    ...
    UserDetailDto disableUser(@Parameter(description = "User UUID") @PathVariable String userUuid)
            throws NotFoundException;
    ...
    List<RoleDto> getUserRoles(@Parameter(description = "User UUID") @PathVariable String userUuid)
            throws NotFoundException;
    ...
    UserDetailDto updateRoles(@Parameter(description = "User UUID") @PathVariable String userUuid,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Role UUIDs", content = @Content(
                    array = @ArraySchema(schema = @Schema(implementation = String.class)),
                    examples = {
                            @ExampleObject(
                                    value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> roleUuids)
            throws NotFoundException;
    ...
    UserDetailDto addRole(@Parameter(description = "User UUID") @PathVariable String userUuid,
            @Parameter(description = "Role UUID") @PathVariable String roleUuid) throws NotFoundException;
    ...
    UserDetailDto removeRole(@Parameter(description = "User UUID") @PathVariable String userUuid,
            @Parameter(description = "Role UUID") @PathVariable String roleUuid) throws NotFoundException;
    ...
    SubjectPermissionsDto getPermissions(@Parameter(description = "User UUID") @PathVariable String userUuid)
            throws NotFoundException;
    ...
    UserDetailDto identifyUser(@RequestBody UserIdentificationRequestDto request)
