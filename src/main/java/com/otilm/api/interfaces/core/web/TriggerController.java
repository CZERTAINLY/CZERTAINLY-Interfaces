...
public interface TriggerController extends AuthProtectedController {
    ...
    List<TriggerHistoryDto> getTriggerHistory(@Parameter(description = "Trigger UUID") @PathVariable String triggerUuid,
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Trigger associations retrieved"),})
