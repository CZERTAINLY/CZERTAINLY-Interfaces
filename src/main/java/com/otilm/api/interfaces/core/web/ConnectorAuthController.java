...
public interface ConnectorAuthController extends AuthProtectedController {
    ...
    @PostMapping(path = "/attributes/basic/validate", consumes = {"application/json"}, produces = {"application/json"})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Attributes validated")})
    @PostMapping(path = "/attributes/apiKey/validate", consumes = {"application/json"}, produces = {"application/json"})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Attributes validated")})
    @PostMapping(path = "/attributes/jwt/validate", consumes = {"application/json"}, produces = {"application/json"})
