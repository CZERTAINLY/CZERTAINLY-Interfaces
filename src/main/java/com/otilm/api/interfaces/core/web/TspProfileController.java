...
public interface TspProfileController extends AuthProtectedController {
    ...
    List<BulkActionMessageDto> bulkDeleteTspProfiles(@io.swagger.v3.oas.annotations.parameters.RequestBody(
            description = "TSP Profile UUIDs",
    ...
    @PatchMapping(path = "/enable", consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    List<BulkActionMessageDto> bulkEnableTspProfiles(@io.swagger.v3.oas.annotations.parameters.RequestBody(
            description = "TSP Profile UUIDs",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = UUID.class)), examples = {
                    @ExampleObject(
                            value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<UUID> uuids);
    ...
    @PatchMapping(path = "/disable", consumes = {MediaType.APPLICATION_JSON_VALUE},
            produces = {MediaType.APPLICATION_JSON_VALUE})
    List<BulkActionMessageDto> bulkDisableTspProfiles(@io.swagger.v3.oas.annotations.parameters.RequestBody(
            description = "TSP Profile UUIDs",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = UUID.class)), examples = {
                    @ExampleObject(
                            value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<UUID> uuids);
