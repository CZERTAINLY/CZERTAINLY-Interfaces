...
public interface ApprovalProfileController extends AuthProtectedController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Approval profile retrieved"),
    ...
    ApprovalProfileDetailDto getApprovalProfile(
            ...
            @Parameter(in = ParameterIn.QUERY,
                    description = "Select specific version of the approval profile") ApprovalProfileForVersionDto approvalProfileForVersionDto)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "New Approval profile created",
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Approval profile updated",
                    content = @Content(schema = @Schema(implementation = UuidDto.class))),
            @ApiResponse(responseCode = "404", description = "Approval profile not found",
                    content = @Content(schema = @Schema(implementation = ErrorMessageDto.class))),
            @ApiResponse(responseCode = "422", description = "Unprocessable Entity",
    ...
    @Operation(operationId = "associateApprovalProfile",
    ...
    @Operation(operationId = "disassociateApprovalProfile",
            summary = "Disassociate Approval Profile from specified resource object")
    @ApiResponses(
            value = {@ApiResponse(responseCode = "204", description = "Resource object disassociation successful")})
    ...
    @Operation(operationId = "getAssociatedApprovalProfiles",
