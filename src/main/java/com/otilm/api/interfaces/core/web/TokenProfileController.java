...
public interface TokenProfileController extends AuthProtectedController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Token Profile details retrieved"),
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Token Profile added"),
    ...
    @PostMapping(path = "/tokens/{tokenInstanceUuid}/tokenProfiles", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Profile updated"),
            @ApiResponse(responseCode = "422", description = "Unprocessible Entity", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"Error Message 1\",\"Error Message 2\"]")})),
    ...
    @PutMapping(path = "/tokens/{tokenInstanceUuid}/tokenProfiles/{uuid}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Profile deleted"),
            @ApiResponse(responseCode = "404", description = "Token Profile not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @DeleteMapping(path = "/tokens/{tokenInstanceUuid}/tokenProfiles/{uuid}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Profile disabled"),
            @ApiResponse(responseCode = "404", description = "Token Profile not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PatchMapping(path = "/tokens/{tokenInstanceUuid}/tokenProfiles/{uuid}/disable", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Profile enabled"),
            @ApiResponse(responseCode = "404", description = "Token Profile not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PatchMapping(path = "/tokens/{tokenInstanceUuid}/tokenProfiles/{uuid}/enable", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Profiles deleted"),
            @ApiResponse(responseCode = "422", description = "Unprocessible Entity", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"Error Message 1\",\"Error Message 2\"]")}))})
    @DeleteMapping(path = "/tokenProfiles", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void deleteTokenProfiles(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Token Profile UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
    ...
    @PatchMapping(path = "/tokenProfiles/disable", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    ...
    @PatchMapping(path = "/tokenProfiles/enable", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void enableTokenProfiles(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Token Profile UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> uuids);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Key Usages Updated"),
            @ApiResponse(responseCode = "404", description = "Token Profile not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PutMapping(path = "/tokens/{tokenInstanceUuid}/tokenProfiles/{tokenProfileUuid}/usages", produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
