...
public interface RoleManagementController extends AuthProtectedController {
    ...
    RoleDetailDto updateUsers(@Parameter(description = "Role UUID") @PathVariable String roleUuid,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "User UUIDs", content = @Content(
                    array = @ArraySchema(schema = @Schema(implementation = String.class)),
                    examples = {
                            @ExampleObject(
                                    value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> userUuids)
            throws NotFoundException;
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Role not found",
                    content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PostMapping(path = "/{roleUuid}/permissions/{resourceUuid}/objects", consumes = {"application/json"},
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Role not found",
                    content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PutMapping(path = "/{roleUuid}/permissions/{resourceUuid}/objects/{objectUuid}", consumes = {"application/json"},
            produces = {"application/json"})
    @ResponseStatus(HttpStatus.NO_CONTENT)
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Role not found",
                    content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @DeleteMapping(path = "/{roleUuid}/permissions/{resourceUuid}/objects/{objectUuid}",
            produces = {"application/json"})
    @ResponseStatus(HttpStatus.NO_CONTENT)
