...
public interface CallbackController extends AuthProtectedController {
    ...
    @PostMapping(path = "/v1/connectors/{uuid}/{functionGroup}/{kind}/callback", consumes = {"application/json"},
    ...
    @Operation(operationId = "callbackV2", summary = "Connector Callback API v2",
            description = "API to trigger the Callback for Connector.")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Callback executed")})
    @PostMapping(path = "/v2/connectors/{uuid}/callback", consumes = {"application/json"},
            produces = {"application/json"})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Callback executed")})
    @PostMapping(path = "/v1/{resource}/{parentObjectUuid}/callback", consumes = {"application/json"},
            produces = {"application/json"})
