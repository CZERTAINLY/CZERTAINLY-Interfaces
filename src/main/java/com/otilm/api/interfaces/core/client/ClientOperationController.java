...
public interface ClientOperationController extends AuthProtectedController {
    ...
    void addEndEntity(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
    ...
    ClientEndEntityDto getEndEntity(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
    ...
    void revokeAndDeleteEndEntity(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Username") @PathVariable String username)
            throws NotFoundException, ConnectorException;
    ...
    void resetPassword(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Username") @PathVariable String username)
            throws NotFoundException, ConnectorException;
