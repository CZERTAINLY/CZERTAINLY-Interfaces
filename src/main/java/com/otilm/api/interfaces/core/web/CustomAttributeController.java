...
public interface CustomAttributeController extends AuthProtectedController {
    ...
    List<CustomAttributeDefinitionDto> listCustomAttributes(
            @RequestParam(required = false) AttributeContentType attributeContentType);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Custom Attribute details retrieved"),
            @ApiResponse(responseCode = "404", description = "Custom attribute not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "Custom Attribute created", content = @Content(schema = @Schema(implementation = UuidDto.class)))})
    @PostMapping(consumes = {"application/json"}, produces = {"application/json"})
    ResponseEntity<CustomAttributeDefinitionDetailDto> createCustomAttribute(
            @RequestBody CustomAttributeCreateRequestDto request) throws AlreadyExistException, AttributeException;
    ...
    CustomAttributeDefinitionDetailDto editCustomAttribute(
            @Parameter(description = "Attribute UUID") @PathVariable String uuid,
            @RequestBody CustomAttributeUpdateRequestDto request) throws NotFoundException, AttributeException;
    ...
    void deleteCustomAttribute(@Parameter(description = "Custom Attribute UUID") @PathVariable String uuid)
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void enableCustomAttribute(@Parameter(description = "Custom Attribute UUID") @PathVariable String uuid)
            throws NotFoundException;
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void disableCustomAttribute(@Parameter(description = "Custom Attribute UUID") @PathVariable String uuid)
            throws NotFoundException;
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void bulkDeleteCustomAttributes(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Attribute UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> attributeUuids);
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void bulkEnableCustomAttributes(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Attribute UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> attributeUuids);
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void bulkDisableCustomAttributes(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Attribute UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> attributeUuids);

    @Operation(summary = "Associate Custom Attribute to Resource")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "Custom Attribute associated to the resources"),
            @ApiResponse(responseCode = "404", description = "Custom attribute not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PatchMapping(path = "/{uuid}/resources", produces = {"application/json"}, consumes = {"application/json"})
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void updateResources(
            @Parameter(description = "Custom Attribute UUID", schema = @Schema(implementation = UUID.class)) @PathVariable String uuid,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "List of Resources", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"raProfiles\",\"authorities\"]")})) @RequestBody List<Resource> resources)
            throws NotFoundException;

    @Operation(summary = "Get Custom Attributes for a resource")
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Custom Attribute retrieved", content = @Content(array = @ArraySchema(schema = @Schema(implementation = CustomAttribute.class))))})
    @GetMapping(path = "/resources/{resource}", produces = {"application/json"})
    List<CustomAttribute> getResourceCustomAttributes(
            @Parameter(description = "Resource Name", schema = @Schema(implementation = Resource.class)) @PathVariable Resource resource);
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Custom Attribute value updated"),
            @ApiResponse(responseCode = "404", description = "Custom attribute not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PatchMapping(path = "/resources/{resourceName}/objects/{objectUuid}/{attributeUuid}", produces = MediaType.APPLICATION_JSON_VALUE)
    List<ResponseAttribute> updateAttributeContentForResource(
            ...
            @RequestBody List<AttributeContent> request) throws NotFoundException, AttributeException;
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Custom Attribute value deleted"),
            @ApiResponse(responseCode = "404", description = "Custom attribute not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @DeleteMapping(path = "/resources/{resourceName}/objects/{objectUuid}/{attributeUuid}", produces = MediaType.APPLICATION_JSON_VALUE)
