...
public interface AcmeController extends NoAuthController {
    ...
    ResponseEntity<Directory> getDirectory(
            @Parameter(description = "ACME Profile name") @PathVariable String acmeProfileName)
    ...
    ResponseEntity<?> keyRollover(@Parameter(description = "ACME Profile name") @PathVariable String acmeProfileName,
    ...
    ResponseEntity<Order> newOrder(@Parameter(description = "ACME Profile name") @PathVariable String acmeProfileName,
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Get Order details payload", required = true,
            content = @Content(mediaType = "application/jose+json", examples = {@ExampleObject(value = "")}))
    ResponseEntity<Order> getOrder(@Parameter(description = "ACME Profile name") @PathVariable String acmeProfileName,
    ...
    @PostMapping(path = "/order/{orderId}/finalize", consumes = {"application/jose+json"},
            produces = {"application/json"})
    ResponseEntity<Order> finalizeOrder(
            @Parameter(description = "ACME Profile name") @PathVariable String acmeProfileName,
            @Parameter(description = "Order Id") @PathVariable String orderId,
    ...
    ResponseEntity<?> revokeCertificate(
            @Parameter(description = "ACME Profile name") @PathVariable String acmeProfileName,
