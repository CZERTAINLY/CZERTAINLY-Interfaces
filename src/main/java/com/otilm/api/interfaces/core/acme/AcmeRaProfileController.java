...
public interface AcmeRaProfileController extends NoAuthController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "New Nonce retrieved", content = @Content(schema = @Schema(hidden = true)))})
    ...
    @Operation(summary = "New Nonce", externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.2", url = "https://datatracker.ietf.org/doc/html/rfc8555#section-7.2"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "New Nonce retrieved", content = @Content(schema = @Schema(hidden = true)))})
    ...
    ResponseEntity<Account> newAccount(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "New Account JWS payload", content = @Content(schema = @Schema(implementation = NewAccountRequest.class))) @RequestBody String jwsBody)
    ...
    ResponseEntity<Account> updateAccount(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Account JWS payload", content = @Content(schema = @Schema(implementation = NewAccountRequest.class))) @RequestBody String jwsBody)
            throws AcmeProblemDocumentException, NotFoundException;
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Account key updated", content = @Content(schema = @Schema(hidden = true))),
    ...
    ResponseEntity<?> keyRollover(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Key Rollover JWS Payload", content = @Content(schema = @Schema(implementation = KeyRollover.class))) @RequestBody String jwsBody)
            throws NotFoundException, AcmeProblemDocumentException;
    ...
    ResponseEntity<Order> newOrder(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "New Order JWS payload", content = @Content(schema = @Schema(implementation = CertificateIssuanceRequest.class))) @RequestBody String jwsBody)
            throws AcmeProblemDocumentException, NotFoundException;
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "List Orders JWS Payload", required = true, content = @Content(mediaType = "application/jose+json", examples = {
            @ExampleObject(value = "")}))
    ...
    @PostMapping(path = "/authz/{authorizationId}", consumes = {"application/jose+json"}, produces = {
            "application/json"})
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Get Authorization of Order JWS Payload", required = true, content = @Content(mediaType = "application/jose+json", examples = {
            @ExampleObject(value = "")}))
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Get Order details payload", required = true, content = @Content(mediaType = "application/jose+json", examples = {
            @ExampleObject(value = "")}))
    ...
    @PostMapping(path = "/order/{orderId}/finalize", consumes = {"application/jose+json"}, produces = {
            "application/json"})
    ResponseEntity<Order> finalizeOrder(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Order Id") @PathVariable String orderId,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Finalize Order JWS payload", content = @Content(schema = @Schema(implementation = CertificateFinalizeRequest.class))) @RequestBody String jwsBody)
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Certificate content retrieved as file", content = @Content(schema = @Schema(hidden = true)))})
    @PostMapping(path = "/cert/{certificateId}", consumes = {"application/jose+json"}, produces = {
            "application/pem-certificate-chain"})
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Download Certificate Payload", required = true, content = @Content(mediaType = "application/jose+json", examples = {
            @ExampleObject(value = "")}))
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Certificate revoked", content = @Content(schema = @Schema(hidden = true)))})
    ...
    ResponseEntity<?> revokeCertificate(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Certificate Revocation JWS payload", content = @Content(schema = @Schema(implementation = CertificateRevocationRequest.class))) @RequestBody String jwsBody)
