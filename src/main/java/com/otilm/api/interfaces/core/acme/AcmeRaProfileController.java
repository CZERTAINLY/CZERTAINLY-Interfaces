...
import com.otilm.api.model.core.acme.CertificateIssuanceRequest;
...
import com.otilm.api.model.core.acme.KeyRollover;
...
/**
 * This class contains the list of end points supported for the ACME implementation in Platform
 */
...
public interface AcmeRaProfileController extends NoAuthController {
    ...
    @Operation(summary = "Get Directory information",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.1.1",
    ...
    ResponseEntity<Directory> getDirectory(
    ...
    @Operation(summary = "New Nonce",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.2",
                    url = "https://datatracker.ietf.org/doc/html/rfc8555#section-7.2"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "204", description = "New Nonce retrieved",
    ...
    @Operation(summary = "New Nonce",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.2",
                    url = "https://datatracker.ietf.org/doc/html/rfc8555#section-7.2"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "New Nonce retrieved",
                    content = @Content(schema = @Schema(hidden = true)))})
    ...
    @Operation(summary = "Create Account",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.3",
    ...
    ResponseEntity<Account> newAccount(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "New Account JWS payload",
                    content = @Content(
                            schema = @Schema(implementation = NewAccountRequest.class))) @RequestBody String jwsBody)
            throws AcmeProblemDocumentException, NotFoundException;

    @Operation(summary = "Update Account",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.3.2",
    ...
    ResponseEntity<Account> updateAccount(
            ...
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Account JWS payload",
                    content = @Content(
                            schema = @Schema(implementation = NewAccountRequest.class))) @RequestBody String jwsBody)
            throws AcmeProblemDocumentException, NotFoundException;

    @Operation(summary = "Key Rollover",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.3.5",
                    url = "https://datatracker.ietf.org/doc/html/rfc8555#section-7.3.5"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Account key updated",
                    content = @Content(schema = @Schema(hidden = true))),
    ...
    ResponseEntity<?> keyRollover(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Key Rollover JWS Payload",
                    content = @Content(
                            schema = @Schema(implementation = KeyRollover.class))) @RequestBody String jwsBody)
            throws NotFoundException, AcmeProblemDocumentException;

    @Operation(summary = "Request new Order",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.4",
    ...
    ResponseEntity<Order> newOrder(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "New Order JWS payload",
                    content = @Content(schema = @Schema(
                            implementation = CertificateIssuanceRequest.class))) @RequestBody String jwsBody)
            throws AcmeProblemDocumentException, NotFoundException;

    @Operation(summary = "List Orders",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.1.2.1",
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "List Orders JWS Payload", required = true,
            content = @Content(mediaType = "application/jose+json", examples = {@ExampleObject(value = "")}))
    ...
    @Operation(summary = "Get Authorizations for an Order",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.5",
    ...
    @PostMapping(path = "/authz/{authorizationId}", consumes = {"application/jose+json"},
            produces = {"application/json"})
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Get Authorization of Order JWS Payload",
            required = true,
            content = @Content(mediaType = "application/jose+json", examples = {@ExampleObject(value = "")}))
    ResponseEntity<Authorization> getAuthorizations(
            @Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Authorization Id") @PathVariable String authorizationId,
            @RequestBody String jwsBody) throws NotFoundException, AcmeProblemDocumentException;

    @Operation(summary = "Validate Challenge",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.5.1",
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Initiate Challenge validation JWS Payload",
            required = true,
            content = @Content(schema = @Schema(implementation = Map.class), mediaType = "application/jose+json"))
    ResponseEntity<Challenge> validateChallenge(
            @Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Challenge Id") @PathVariable String challengeId)
            throws NotFoundException, NoSuchAlgorithmException, InvalidKeySpecException, AcmeProblemDocumentException;

    @Operation(summary = "Get Order details",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.1.3",
    ...
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Get Order details payload", required = true,
            content = @Content(mediaType = "application/jose+json", examples = {@ExampleObject(value = "")}))
    ResponseEntity<Order> getOrder(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Order Id") @PathVariable String orderId)
            throws NotFoundException, AcmeProblemDocumentException;

    @Operation(summary = "Finalize Order", externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.4",
    ...
    @PostMapping(path = "/order/{orderId}/finalize", consumes = {"application/jose+json"},
            produces = {"application/json"})
    ResponseEntity<Order> finalizeOrder(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Order Id") @PathVariable String orderId,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Finalize Order JWS payload",
                    content = @Content(schema = @Schema(
                            implementation = CertificateFinalizeRequest.class))) @RequestBody String jwsBody)
            throws AcmeProblemDocumentException, ConnectorException, JsonProcessingException, CertificateException,
            AlreadyExistException;

    @Operation(summary = "Download Certificate",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.4.2",
                    url = "https://datatracker.ietf.org/doc/html/rfc8555#section-7.4.2"))
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Certificate content retrieved as file",
                    content = @Content(schema = @Schema(hidden = true)))})
    @PostMapping(path = "/cert/{certificateId}", consumes = {"application/jose+json"},
            produces = {"application/pem-certificate-chain"})
    @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Download Certificate Payload", required = true,
            content = @Content(mediaType = "application/jose+json", examples = {@ExampleObject(value = "")}))
    ResponseEntity<Resource> downloadCertificate(
            @Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @Parameter(description = "Certificate Id") @PathVariable String certificateId)
            throws NotFoundException, CertificateException;

    @Operation(summary = "Revoke Certificate",
            externalDocs = @ExternalDocumentation(description = "RFC 8555, section 7.6",
    ...
    ResponseEntity<?> revokeCertificate(@Parameter(description = "RA Profile name") @PathVariable String raProfileName,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Certificate Revocation JWS payload",
                    content = @Content(schema = @Schema(
                            implementation = CertificateRevocationRequest.class))) @RequestBody String jwsBody)
            throws AcmeProblemDocumentException, ConnectorException, CertificateException;
}
