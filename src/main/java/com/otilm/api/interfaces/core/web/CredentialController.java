...
public interface CredentialController extends AuthProtectedController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = "New Credential added", content = @Content(schema = @Schema(implementation = UuidDto.class))),
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void bulkDeleteCredential(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Credential UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
