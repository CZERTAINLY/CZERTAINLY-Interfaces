...
public interface TokenInstanceController extends AuthProtectedController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Token Instance Detail retrieved"),
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "Token Instance Created Successfully"),
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Instance deleted"),
            @ApiResponse(responseCode = "404", description = "Token Instance not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Instance Activated"),
            @ApiResponse(responseCode = "404", description = "Token Instance not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @PatchMapping(path = "/{uuid}/activate", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Instance Deactivated"),
            @ApiResponse(responseCode = "404", description = "Token Instance not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "204", description = "Token Instances deleted"),
            @ApiResponse(responseCode = "404", description = "Token Instance not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    @DeleteMapping(path = "/delete", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void deleteTokenInstance(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Token Instance UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
