...
public interface ConnectorController extends AuthProtectedController {
    ...
    void bulkApprove(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Connector UUIDs",
    ...
    void bulkReconnect(@io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Connector UUIDs",
            content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(
                            value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> uuids)
            throws ValidationException, NotFoundException, ConnectException, ConnectorException;
    ...
    @PostMapping(path = "/{uuid}/{functionGroup}/{kind}/validate", consumes = {"application/json"},
