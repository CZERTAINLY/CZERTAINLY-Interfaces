...
public interface TimeQualityConfigurationController extends AuthProtectedController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Time Quality Configuration details retrieved")})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "201", description = "New Time Quality Configuration added"),
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Time Quality Configuration updated"),
            @ApiResponse(responseCode = "409", description = "Already Exists", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class))),
            @ApiResponse(responseCode = "422", description = "Unprocessable Entity", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"Error Message 1\",\"Error Message 2\"]")})),})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Time Quality Configurations deleted"),
            @ApiResponse(responseCode = "422", description = "Unprocessable Entity", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"Error Message 1\",\"Error Message 2\"]")}))})
    @DeleteMapping(consumes = {MediaType.APPLICATION_JSON_VALUE}, produces = {MediaType.APPLICATION_JSON_VALUE})
    List<BulkActionMessageDto> bulkDeleteTimeQualityConfigurations(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Time Quality Configuration UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = UUID.class)), examples = {
