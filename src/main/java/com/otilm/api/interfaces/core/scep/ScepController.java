...
public interface ScepController extends NoAuthController {
    ...
    @GetMapping
    ResponseEntity<Object> doGet(@PathVariable String scepProfileName, @RequestParam String operation,
    ...
    ResponseEntity<Object> doPost(@PathVariable String scepProfileName, @RequestParam String operation,
