...
public interface AcmeProfileController extends AuthProtectedController {
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "ACME Profile details retrieved"),
            @ApiResponse(responseCode = "404", description = "ACME Profile not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    ...
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "ACME Profile updated"),
            @ApiResponse(responseCode = "404", description = "ACME Profile or RA profile not found", content = @Content(schema = @Schema(implementation = ErrorMessageDto.class)))})
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    void bulkEnableAcmeProfile(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "ACME Profile UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
    ...
    List<BulkActionMessageDto> bulkDeleteAcmeProfile(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "ACME Profile UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> uuids);
    ...
    List<BulkActionMessageDto> forceDeleteACMEProfiles(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "ACME Profile UUIDs", content = @Content(array = @ArraySchema(schema = @Schema(implementation = String.class)), examples = {
                    @ExampleObject(value = "[\"c2f685d4-6a3e-11ec-90d6-0242ac120003\",\"b9b09548-a97c-4c6a-a06a-e4ee6fc2da98\"]")})) @RequestBody List<String> uuids)
            throws NotFoundException, ValidationException;
