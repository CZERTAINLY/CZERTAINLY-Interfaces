...
/**
 * Interface for synchronous end entity profile operations against connectors. Implementations can use REST (direct
 * HTTP) or MQ (proxy) communication.
 */
public interface EndEntityProfileSyncApiClient {
     ...
     */
    List<NameAndIdDto> listEndEntityProfiles(ApiClientConnectorInfo connector, String authorityUuid)
     ...
     * @throws ConnectorException If request fails
     */
    List<NameAndIdDto> listCertificateProfiles(ApiClientConnectorInfo connector, String authorityUuid,
     ...
     * @throws ConnectorException If request fails
     */
    List<NameAndIdDto> listCAsInProfile(ApiClientConnectorInfo connector, String authorityUuid, int endEntityProfileId)
            throws ConnectorException;
}
