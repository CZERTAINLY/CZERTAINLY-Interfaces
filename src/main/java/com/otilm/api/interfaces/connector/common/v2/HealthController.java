...
@Tag(name = "Health check v2",
        description = "Connector Health check API. " + "Connector returns own status and in some cases "
...
public interface HealthController extends NoAuthConnectorController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Health check retrieved successfully"),
