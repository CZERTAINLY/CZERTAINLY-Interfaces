...
@Tag(name = "Certificate Management v3", description = "Stateless v3 certificate operations by utilizing attributes in request for identifying authority or RA profile")
public interface CertificateController extends AuthProtectedConnectorController {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Issued synchronously"),
    ...
    @ApiResponses({@ApiResponse(responseCode = "204", description = "Aborted"),
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Renewed synchronously"),
    ...
    @ApiResponses({@ApiResponse(responseCode = "204", description = "Revoked synchronously"),
