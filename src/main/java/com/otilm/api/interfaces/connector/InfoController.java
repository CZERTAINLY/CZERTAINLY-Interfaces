...
@RequestMapping("/v1")
@Tag(name = "Connector Info", description = "Connector Information API. "
...
public interface InfoController extends AuthProtectedConnectorController {
    ...
    @Operation(summary = "List supported functions of the connector", description = "Returns map of functional code and implemented end points")
    @ApiResponses(value = {@ApiResponse(responseCode = "200", description = "Functions found")})
