...
public interface CryptographicOperationsController extends AuthProtectedConnectorController {
     ...
     */
    EncryptDataResponseDto encryptData(@Parameter(description = "Token instance UUID") @PathVariable String uuid,
     ...
     * @throws NotFoundException Token instance or Key not found
     */
    DecryptDataResponseDto decryptData(@Parameter(description = "Token instance UUID") @PathVariable String uuid,
            @Parameter(description = "Key UUID") @PathVariable String keyUuid,
            @RequestBody CipherDataRequestDto request) throws NotFoundException;
     ...
     * @throws NotFoundException Token instance or Key not found
     */
    SignDataResponseDto signData(@Parameter(description = "Token instance UUID") @PathVariable String uuid,
            @Parameter(description = "Key UUID") @PathVariable String keyUuid, @RequestBody SignDataRequestDto request)
     ...
     * @throws NotFoundException Token instance or Key not found
     */
    VerifyDataResponseDto verifyData(@Parameter(description = "Token instance UUID") @PathVariable String uuid,
            @Parameter(description = "Key UUID") @PathVariable String keyUuid,
            @RequestBody VerifyDataRequestDto request) throws NotFoundException;
     ...
     */
    List<BaseAttribute> listRandomAttributes(@Parameter(description = "Token instance UUID") @PathVariable String uuid)
            throws NotFoundException;
     ...
     */
    void validateRandomAttributes(@Parameter(description = "Token instance UUID") @PathVariable String uuid,
     ...
     * @throws NotFoundException Token instance not found
     */
    RandomDataResponseDto randomData(@Parameter(description = "Token instance UUID") @PathVariable String uuid,
            @RequestBody RandomDataRequestDto request) throws NotFoundException;
