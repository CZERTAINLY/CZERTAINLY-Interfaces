...
public enum PadesSignatureScope implements IPlatformEnum {
    ...
    CERTIFICATION(Codes.CERTIFICATION, "Certification",
            "A certification signature. Changes to the document afterwards are limited to form filling and "
                    + "further signatures; the permission level is fixed and not configurable. Only the first "
                    + "signature in a document may certify."),
