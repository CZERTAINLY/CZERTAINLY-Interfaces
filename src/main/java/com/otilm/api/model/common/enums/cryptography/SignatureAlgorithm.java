...
public enum SignatureAlgorithm implements IPlatformEnum {
    SHA256_WITH_RSA("SHA256withRSA", "RSASSA-PKCS_v1.5 using SHA256", "RSA signature with SHA-256 digest",
            ...
            new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256), false), SHA384_WITH_RSA("SHA384withRSA",
                    "RSASSA-PKCS_v1.5 using SHA384", "RSA signature with SHA-384 digest",
                    new AlgorithmIdentifier(PKCSObjectIdentifiers.sha384WithRSAEncryption, DERNull.INSTANCE),
                    new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha384), false), SHA512_WITH_RSA("SHA512withRSA",
                            "RSASSA-PKCS_v1.5 using SHA512", "RSA signature with SHA-512 digest",
                            ...
                            false), SHA256_WITH_RSA_PSS("SHA256withRSAandMGF1", "RSASSA-PSS using SHA256",
                                    "RSA-PSS signature with SHA-256 digest",
                                    createPssAlgorithmIdentifier(NISTObjectIdentifiers.id_sha256, 32),
                                    new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256),
                                    false), SHA384_WITH_RSA_PSS("SHA384withRSAandMGF1", "RSASSA-PSS using SHA384",
                                            "RSA-PSS signature with SHA-384 digest",
                                            createPssAlgorithmIdentifier(NISTObjectIdentifiers.id_sha384, 48),
                                            new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha384),
                                            false), SHA512_WITH_RSA_PSS("SHA512withRSAandMGF1",
                                                    "RSASSA-PSS using SHA512", "RSA-PSS signature with SHA-512 digest",
                                                    createPssAlgorithmIdentifier(NISTObjectIdentifiers.id_sha512, 64),
                                                    new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha512),
                                                    false), SHA256_WITH_ECDSA("SHA256withECDSA", "ECDSA using SHA256",
                                                            "ECDSA signature with SHA-256 digest",
                                                            new AlgorithmIdentifier(
                                                                    X9ObjectIdentifiers.ecdsa_with_SHA256),
                                                            new AlgorithmIdentifier(NISTObjectIdentifiers.id_sha256),
                                                            false), SHA384_WITH_ECDSA("SHA384withECDSA",
                                                                    "ECDSA using SHA384",
                                                                    "ECDSA signature with SHA-384 digest",
                                                                    new AlgorithmIdentifier(
                                                                            X9ObjectIdentifiers.ecdsa_with_SHA384),
                                                                    new AlgorithmIdentifier(
                                                                            NISTObjectIdentifiers.id_sha384),
                                                                    false), SHA512_WITH_ECDSA("SHA512withECDSA",
                                                                            "ECDSA using SHA512",
                                                                            "ECDSA signature with SHA-512 digest",
                                                                            new AlgorithmIdentifier(
                                                                                    X9ObjectIdentifiers.ecdsa_with_SHA512),
                                                                            new AlgorithmIdentifier(
                                                                                    NISTObjectIdentifiers.id_sha512),
                                                                            false), ED25519("Ed25519",
                                                                                    "Pure EdDSA with Edwards25519",
                                                                                    "Edwards-curve DSA with Curve25519",
                                                                                    new AlgorithmIdentifier(
                                                                                    ...
                                                                                    true), ED448("Ed448",
                                                                                            ...
                                                                                            "Edwards-curve DSA with Curve448",
                                                                                            new AlgorithmIdentifier(
                                                                                                    new ASN1ObjectIdentifier(
                                                                                                            "1.3.101.113")),
                                                                                            new AlgorithmIdentifier(
                                                                                            ...
                                                                                            true), FALCON_1024(
                                                                                                    "FALCON-1024",
                                                                                                    "FALCON-1024",
                                                                                                    "Post-quantum FALCON-1024 lattice-based signature scheme",
                                                                                                    new AlgorithmIdentifier(
                                                                                                            new ASN1ObjectIdentifier(
                                                                                                                    "1.3.9999.3.14")),
                                                                                                    new AlgorithmIdentifier(
