...
public enum AttributeContentType implements IPlatformEnum {
    ...
    INTEGER(Codes.INTEGER, "Integer number", IntegerAttributeContentV2.class, IntegerAttributeContentV3.class,
            Integer.class, true),
    BOOLEAN(Codes.BOOLEAN, "Boolean", BooleanAttributeContentV2.class, BooleanAttributeContentV3.class, Boolean.class,
            true),
    FLOAT(Codes.FLOAT, "Decimal number", FloatAttributeContentV2.class, FloatAttributeContentV3.class, Float.class,
            true),
    ...
    DATETIME(Codes.DATETIME, "DateTime", DateTimeAttributeContentV2.class, DateTimeAttributeContentV3.class,
    ...
    FILE(Codes.FILE, "File", FileAttributeContentV2.class, FileAttributeContentV3.class, FileAttributeContentData.class,
            false),
    CREDENTIAL(Codes.CREDENTIAL, "Credential", CredentialAttributeContentV2.class, null,
            CredentialAttributeContentData.class, false),
    CODEBLOCK(Codes.CODEBLOCK, "Code block", CodeBlockAttributeContentV2.class, CodeBlockAttributeContentV3.class,
            CodeBlockAttributeContentData.class, false),
    OBJECT(Codes.OBJECT, "Object", ObjectAttributeContentV2.class, ObjectAttributeContentV3.class, Object.class, false),
    RESOURCE(Codes.RESOURCE, "Resource Object", null, ResourceObjectContent.class, ResourceObjectContentData.class,
            false);
