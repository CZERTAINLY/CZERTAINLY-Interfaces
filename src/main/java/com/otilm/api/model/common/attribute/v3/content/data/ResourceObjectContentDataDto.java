...
@Schema(name = "ResourceObjectContentData", description = "", type = "object", discriminatorProperty = "resource",
        discriminatorMapping = {
                ...
                @DiscriminatorMapping(value = Resource.Codes.CERTIFICATE,
                        schema = ResourceCertificateContentData.class),
...
public interface ResourceObjectContentDataDto extends AttributeContentData {
    ...
    @Schema(description = "Resource identifier", examples = {"7b55ge1c-844f-11dc-a8a3-0242ac120002"},
            requiredMode = Schema.RequiredMode.REQUIRED)
    String getUuid();

    @Schema(description = "Resource name", examples = {"Main authority"}, requiredMode = Schema.RequiredMode.REQUIRED)
    String getName();

    @Schema(description = "Resource contained in data", example = Resource.Codes.AUTHORITY,
            requiredMode = Schema.RequiredMode.REQUIRED)
