...
@Schema(name = "ResourceObjectContentData", description = "", type = "object", discriminatorProperty = "resource", discriminatorMapping = {
        ...
        @DiscriminatorMapping(value = Resource.Codes.SECRET, schema = ResourceSecretContentData.class),}, oneOf = {
                ResourceSimpleContentData.class, ResourceCertificateContentData.class,
                ResourceSecretContentData.class,})
public interface ResourceObjectContentDataDto extends AttributeContentData {

    @Schema(description = "Resource identifier", examples = {
