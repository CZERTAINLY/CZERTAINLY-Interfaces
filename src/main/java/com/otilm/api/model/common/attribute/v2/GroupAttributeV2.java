...
public class GroupAttributeV2 extends BaseAttributeV2<List<BaseAttributeV2<?>>> {
     ...
     **/
    @ArraySchema(schema = @Schema(ref = "BaseAttributeDtoV2"), arraySchema = @Schema(description = "List of all different types of attributes"))
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof GroupAttributeV2 that)) {
            return false;
        }
        if (!super.equals(o)) {
            return false;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), content, attributeCallback);
    }
}
