...
public class ProblemDetailExtended extends ProblemDetail {
    ...
    @Schema(description = "RFC 9457 type URI identifying the problem type", requiredMode = Schema.RequiredMode.REQUIRED,
            format = "uri", example = "https://docs.otilm.com/problems/common/validation-failed")
    @Override
    @NonNull
    public URI getType() {
    ...
    @Schema(description = "HTTP status code (MUST match the actual response code)",
            requiredMode = Schema.RequiredMode.REQUIRED, example = "422", minimum = "100", maximum = "599")
    @Override
    ...
    @Schema(description = "Timestamp of when the error occurred (RFC 3339 format)",
            requiredMode = Schema.RequiredMode.REQUIRED,
            examples = {"2026-01-22T15:10:20.123Z", "2026-01-22T15:10:20.123+02:00"})
    private OffsetDateTime timestamp;

    @Schema(description = "Correlation ID for tracking the request. Trace value from X-Request-Id or W3C Trace Context.",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String correlationId;

    @Schema(description = "Indicates if the operation that caused the error can be retried safely",
            requiredMode = Schema.RequiredMode.REQUIRED)
    private boolean retryable;

    @Schema(description = "Backoff hint, number of seconds after which the client can retry the operation. Aligns with Retry-After header.",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED)
