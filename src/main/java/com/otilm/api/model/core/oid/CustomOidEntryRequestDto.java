...
public class CustomOidEntryRequestDto extends CustomOidEntryUpdateRequestDto implements Serializable {
    ...
    @Schema(description = "Object Identifier (OID) in dot notation (e.g., 1.2.840.113549.1.1.1)", requiredMode = Schema.RequiredMode.REQUIRED, example = "1.2.840.113549.1.1.1")
    @NotBlank
