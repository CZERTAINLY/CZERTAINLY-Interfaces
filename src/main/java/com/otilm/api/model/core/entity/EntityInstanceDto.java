...
public class EntityInstanceDto extends NameAndUuidDto {
    ...
    @Schema(description = "Status of Entity instance", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String status;

    @Schema(description = "UUID of Entity Provider", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
