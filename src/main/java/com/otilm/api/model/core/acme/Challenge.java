...
public class Challenge {
     ...
     */
    @Schema(description = "Type of Challenge", requiredMode = Schema.RequiredMode.REQUIRED, examples = {"dns-01"})
    ...
    /**
     * Status of the Challenge. The possible values are "pending", "processing", "valid", "invalid" This is a mandatory
     * field.
     */
    @Schema(description = "Challenge status", requiredMode = Schema.RequiredMode.REQUIRED)
    private ChallengeStatus status;

    /**
     * Time at which the server validated this Challenge. This data is encoded in the format specified in RFC3339. This
     * is a Non-Mandatory parameter bus is required if the status of the status field is set to valid
     */
     ...
     * [RFC7807]. Multiple errors can be indicated by using subproblems. A challenge object with an error MUST have
