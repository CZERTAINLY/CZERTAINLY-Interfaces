...
public class Order {
     ...
     */
    @Schema(description = "URL to finalize the Order. Mandatory if the Order is in ready state", examples = {
     ...
     * non-mandatory field
     */
    @Schema(description = "URL to download the Certificate", examples = {
