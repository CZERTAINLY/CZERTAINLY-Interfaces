...
public class KeyDetailDto extends NameAndUuidDto {
    ...
    @Schema(description = "Custom Attributes for the Cryptographic Key", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private List<ResponseAttribute> customAttributes;

    @Schema(description = "Attributes for the Cryptographic Key", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Key Objects", requiredMode = Schema.RequiredMode.REQUIRED)
    private List<KeyItemDetailDto> items;

    @Schema(description = "List of associated items", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
