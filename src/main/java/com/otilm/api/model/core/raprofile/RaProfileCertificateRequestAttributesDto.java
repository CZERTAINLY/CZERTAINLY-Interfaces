...
/**
 * View of an RA Profile's static request-attribute set: the ordered platform-owned definitions and the merge mode that
 * governs a combination with a connector-supplied set.
 */
@Getter
@Setter
@ToString
