...
public class Directory {
     ...
     */
    @Schema(description = "URL to get new Nonce", requiredMode = Schema.RequiredMode.REQUIRED,
     ...
     */
    @Schema(description = "URL for the new Account", requiredMode = Schema.RequiredMode.REQUIRED,
     ...
     */
    @Schema(description = "URL for the new Order", requiredMode = Schema.RequiredMode.REQUIRED,
     ...
     */
    @Schema(description = "URL for the new Authorization", requiredMode = Schema.RequiredMode.REQUIRED,
     ...
     * revocation
     */
    @Schema(description = "URL for revoking a certificate", requiredMode = Schema.RequiredMode.REQUIRED,
     ...
     * for an Account
     */
    @Schema(description = " URL for changing the key of an Account", requiredMode = Schema.RequiredMode.REQUIRED,
