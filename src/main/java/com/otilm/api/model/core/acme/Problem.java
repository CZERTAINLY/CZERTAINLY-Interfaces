...
public enum Problem {
    ...
    ALREADY_REVOKED("alreadyRevoked", "Certificate already revoked",
    ...
    BAD_REVOCATION_REASON("badRevocationReason", "Bad Revocation Reason",
            "The revocation reason provided is not supported by the server"),
    BAD_SIGNATURE_ALGORITHM("badSignatureAlgorithm", "Bad Signature Algorithm",
            "The JWS was signed with an algorithm the server does not support"),
    CAA("caa", "Certificate Authority Authorization Forbidden",
    ...
    EXTERNAL_ACCOUNT_REQUIRED("externalAccountRequired", "External Account Required",
            "The request must incluide a value for \"externalAccountBinding\" field"),
    INCORRECT_RESPONSE("incorrectResponse", "Validation Response Incorrect",
    ...
    ORDER_NOT_READY("orderNotReady", "Order Not Ready",
    ...
    REJECTED_IDENTIFIER("rejectedIdentifier", "Identifier Rejected",
    ...
    UNSUPPORTED_CONTACT("unsupportedContact", "Unsupported Contact",
            "A contact for an account used an unsupported protocol scheme"),
    UNSUPPORTED_IDENTIFIER("unsupportedIdentifier", "Unsupported Identifier",
            "An identifier is of an unsupported type"),
    USER_ACTION_REQUIRED("userActionRequired", "User Action Required",
