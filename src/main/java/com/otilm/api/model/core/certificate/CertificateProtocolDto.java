...
public class CertificateProtocolDto {
    ...
    @Schema(description = "UUID of the protocol profile the certificate was issued through. Null when the profile is not known, e.g. when the association predates tracking or the profile was removed.",
