...
public enum CertificateSubjectType implements IPlatformEnum {
    ...
    SELF_SIGNED_END_ENTITY("selfSignedEndEntity", "Self-signed End Entity",
            "Certificate signed by itself, not issued by certificate authority."),
    INTERMEDIATE_CA("intermediateCa", "Intermediate CA",
