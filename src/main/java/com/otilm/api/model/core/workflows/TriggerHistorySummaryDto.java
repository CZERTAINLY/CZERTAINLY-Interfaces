...
public class TriggerHistorySummaryDto {
    @Schema(description = "Resource of the object associated with triggers.",
    ...
    @Schema(description = "Resource of objects that triggers has been evaluated on.",
            requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "List of history of objects that triggers has been evaluated on.",
            requiredMode = Schema.RequiredMode.REQUIRED)
