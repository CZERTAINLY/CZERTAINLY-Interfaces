...
public class JwkDto implements Serializable {
    ...
    @Schema(description = "The key ID parameter used to match a specific key in provider",
    ...
    @Schema(description = "The cryptographic algorithm family used with the key, such as \"RSA\" or \"EC\"",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String keyType;

    @Schema(description = "The algorithm intended for use with the key",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED)
