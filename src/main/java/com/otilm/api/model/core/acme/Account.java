...
public class Account {
    ...
    /**
     * Status of the ACME Account registered with the ACME server. Possible values are "valid", "deactivated", and
    ...
    /**
     * Contact field in the ACME Account attribute. This contains the array of URLs that the server can use to contact
     * the client for issues related to this Account. This is an optional parameter.
     */
    @Schema(description = "List of contacts for ACME Account", example = "[\"mailto:someadmin@domain.com\"]")
    private List<String> contact;

    /**
     * This field represents the status of the Terms of Service agreed or not. This field will be included in a new
     * Account request indicating the client has agreed to the termsOfService. This field cannot be updated by the
     * client. This is a non-mandatory field.
     */
    @Schema(description = "Terms of Service agreed flag. Yes = true, No = false", example = "true")
