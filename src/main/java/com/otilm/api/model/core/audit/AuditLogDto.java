...
public class AuditLogDto {
    ...
    @Schema(description = "Log schema version", requiredMode = Schema.RequiredMode.REQUIRED)
    private String version;

    @Schema(description = "Time when the audit log is stored", requiredMode = Schema.RequiredMode.REQUIRED)
    private OffsetDateTime loggedAt;

    @Schema(description = "Time when the audit log has been created", requiredMode = Schema.RequiredMode.REQUIRED)
    private OffsetDateTime timestamp;

    @Schema(description = "Module of platform where log occurred", requiredMode = Schema.RequiredMode.REQUIRED)
    private Module module;

    @Schema(description = "Actor of log record", requiredMode = Schema.RequiredMode.REQUIRED)
    private ActorRecord actor;

    @Schema(description = "Source of log record", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
