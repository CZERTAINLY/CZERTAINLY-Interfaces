...
public class RaProfileDto extends NameAndUuidDto {
    ...
    @Schema(description = "Description of RA Profile", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String description;

    @Schema(description = "UUID of Authority provider", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
    private String authorityInstanceUuid;

    @Schema(description = "Name of Authority instance", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
