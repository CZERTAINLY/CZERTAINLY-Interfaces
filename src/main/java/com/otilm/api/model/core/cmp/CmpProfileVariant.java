...
public enum CmpProfileVariant implements IPlatformEnum {
    ...
    V2("v2", "CMPv2", "Implementation of RFC 4210 and RFC 4211 (CMP version 2)"), V2_3GPP("v2_3gpp", "CMPv2 3GPP",
            "3GPP implementation based on CMPv2"), V3("v3", "CMPv3",
                    "Implementation of RFC 9483 (lightweight cmp protocol, CMP version 3)"),;
