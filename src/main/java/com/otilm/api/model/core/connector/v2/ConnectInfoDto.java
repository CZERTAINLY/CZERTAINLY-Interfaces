...
@Schema(description = "Connect Info dependent on connector version", type = "object", discriminatorProperty = "version", discriminatorMapping = {
        @DiscriminatorMapping(value = "v1", schema = ConnectInfoV1.class),
        @DiscriminatorMapping(value = "v2", schema = ConnectInfoV2.class)}, oneOf = {ConnectInfoV1.class,
                ConnectInfoV2.class,})
