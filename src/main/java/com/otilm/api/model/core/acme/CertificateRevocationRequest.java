...
/**
 * Fields to be used by the client for revoking a certificate issued to the same Account
 */
public class CertificateRevocationRequest {
    ...
    /**
     * Reason for the Certificate revocation. The reason is as specified by the
     * <a href="https://www.rfc-editor.org/rfc/rfc5280.html#section-5.3.1">RFC5280 section 5.3.1</a> The value is
     * optional. If none of the reason is given, then the server can leave the reason blank for OCSP meaning the server
