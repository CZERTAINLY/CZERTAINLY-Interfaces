...
/**
 * Flat discovery {@code stateChanged} event. Advisory only: Core verifies any transition via an authoritative
 * {@code status} call before committing it; this event never commits a transition on its own.
 */
@Getter
@Setter
@ToString
