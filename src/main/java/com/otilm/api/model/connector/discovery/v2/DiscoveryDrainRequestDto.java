...
public class DiscoveryDrainRequestDto extends DiscoveryV2ScopedRequestDto {
    ...
    /**
     * Hard cap on {@code maxBytes}: 10 MiB, the largest single response the platform's tunneled
     * transport carries. Declared once and referenced by {@code maxBytes}'s bean-validation bound,
     * its published schema {@code maximum}, and its prose, so the three cannot disagree.
     */
