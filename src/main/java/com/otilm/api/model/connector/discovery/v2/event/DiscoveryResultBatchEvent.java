...
/**
 * Flat discovery {@code resultBatch} event: a batch of discovered items pushed on a held-open NDJSON stream or an AMQP
 * {@code discovery.event} message. Each item carries its own per-run sequence; the event itself is unsequenced.
 */
@Getter
@Setter
@ToString
