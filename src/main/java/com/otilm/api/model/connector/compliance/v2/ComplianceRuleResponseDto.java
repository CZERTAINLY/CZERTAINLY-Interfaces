...
public class ComplianceRuleResponseDto {
    ...
    @Schema(description = "UUID of the group to which the rule belongs to",
            requiredMode = Schema.RequiredMode.NOT_REQUIRED, example = "b11c9be1-b619-4ef5-be1b-a1cd9ef265b7")
    ...
    @Schema(description = "Type of the resource object to which this rule can be applied",
