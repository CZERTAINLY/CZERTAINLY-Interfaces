 ...
 */
@Schema(name = "TokenStatusV2", enumAsRef = true, description = "Provider-observable token status")
public enum TokenStatusV2 implements IPlatformEnum {
    ...
    public static TokenStatusV2 findByCode(String code) {
        return Arrays
                ...
                .findFirst()
                .orElseThrow(() -> new ValidationException(ValidationError.create("Unknown V2 token status {}", code)));
    }
}
