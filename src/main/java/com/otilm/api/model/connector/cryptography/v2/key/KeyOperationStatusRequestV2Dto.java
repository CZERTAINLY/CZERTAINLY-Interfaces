...
/**
 * Body for the V2 key-operation status endpoints. Supply the {@code operationMeta} returned by the original
 * 202 Accepted response.
 */
@Getter
@Setter
@ToString(callSuper = true)
public class KeyOperationStatusRequestV2Dto extends TokenProfileScopedRequestV2Dto {
