...
/**
 * Flat discovery {@code error} event. Advisory and non-terminal: Core folds this into the run's
 * message/failure-reason log. Terminal failure is only ever committed from a {@code status}
 * response with state {@code FAILED}.
 */
@Getter
@Setter
@ToString
