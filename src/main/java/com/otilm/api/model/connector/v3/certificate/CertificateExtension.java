...
public class CertificateExtension {
    ...
    @Schema(description = "OID of the X.509 extension (dotted-decimal, RFC 5280)", example = "2.5.29.37",
    ...
    @Schema(description = "DER-encoded extension value, Base64-encoded", format = "byte",
            requiredMode = Schema.RequiredMode.REQUIRED)
