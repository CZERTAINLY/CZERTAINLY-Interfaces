...
@Schema(name = "SecretContent", description = "Secret content dependent on secret type", type = "object", discriminatorProperty = "type", discriminatorMapping = {
        ...
        @DiscriminatorMapping(value = SecretType.Codes.GENERIC, schema = GenericSecretContent.class),}, oneOf = {
                BasicAuthSecretContent.class, ApiKeySecretContent.class, JwtTokenSecretContent.class,
                PrivateKeySecretContent.class, SecretKeySecretContent.class, KeyStoreSecretContent.class,
                KeyValueSecretContent.class, GenericSecretContent.class})
