...
@Schema(name = "ManagedSigningRequestSchemeInterface",
        description = "Managed signing request configuration dependent on the managed signing type", type = "object",
        discriminatorProperty = "managedSigningType",
        discriminatorMapping = {
                @DiscriminatorMapping(value = ManagedSigningType.Codes.STATIC_KEY,
                        schema = StaticKeyManagedSigningRequestDto.class),
                @DiscriminatorMapping(value = ManagedSigningType.Codes.ONE_TIME_KEY,
                        schema = OneTimeKeyManagedSigningRequestDto.class),},
        oneOf = {StaticKeyManagedSigningRequestDto.class, OneTimeKeyManagedSigningRequestDto.class,})
