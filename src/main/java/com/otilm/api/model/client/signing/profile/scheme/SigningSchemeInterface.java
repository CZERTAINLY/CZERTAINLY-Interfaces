...
@Schema(name = "SigningSchemeInterface", description = "Signing Scheme configuration dependent on signing scheme",
        type = "object", discriminatorProperty = "signingScheme",
        ...
        oneOf = {DelegatedSigningDto.class, ManagedSigningDto.class,})
