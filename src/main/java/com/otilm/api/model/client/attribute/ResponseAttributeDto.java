...
@Schema(name = "ResponseAttribute", description = "Response attribute to send attribute content for object",
        type = "object", discriminatorProperty = "version",
        ...
        oneOf = {ResponseAttributeV2.class, ResponseAttributeV3.class})
