...
@Schema(name = "ResponseAttribute", description = "Response attribute to send attribute content for object", type = "object", discriminatorProperty = "version", discriminatorMapping = {
        @DiscriminatorMapping(value = AttributeVersion.Codes.V2, schema = ResponseAttributeV2.class),
        @DiscriminatorMapping(value = AttributeVersion.Codes.V3, schema = ResponseAttributeV3.class),}, oneOf = {
                ResponseAttributeV2.class, ResponseAttributeV3.class})
