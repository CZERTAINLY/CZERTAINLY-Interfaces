...
@Schema(name = "SigningSchemeRequestInterface",
        description = "Signing Scheme request configuration dependent on signing scheme", type = "object",
        ...
        oneOf = {DelegatedSigningRequestDto.class, ManagedSigningRequestDto.class,})
