...
@Schema(name = "RequestAttribute", description = "Request attribute to send attribute content for object",
        ...
        oneOf = {RequestAttributeV3.class, RequestAttributeV2.class})
