...
@Schema(description = "Base Attribute Content", type = "object", discriminatorProperty = "contentType",
        discriminatorMapping = {
                @DiscriminatorMapping(value = AttributeContentType.Codes.BOOLEAN,
                        schema = BooleanAttributeContentV3.class),
                @DiscriminatorMapping(value = AttributeContentType.Codes.CODEBLOCK,
                        schema = CodeBlockAttributeContentV3.class),
                @DiscriminatorMapping(value = AttributeContentType.Codes.DATE, schema = DateAttributeContentV3.class),
                @DiscriminatorMapping(value = AttributeContentType.Codes.DATETIME,
                        schema = DateTimeAttributeContentV3.class),
                ...
                @DiscriminatorMapping(value = AttributeContentType.Codes.INTEGER,
                        schema = IntegerAttributeContentV3.class),
                @DiscriminatorMapping(value = AttributeContentType.Codes.OBJECT,
                        schema = ObjectAttributeContentV3.class),
                @DiscriminatorMapping(value = AttributeContentType.Codes.STRING,
                        schema = StringAttributeContentV3.class),
                ...
                @DiscriminatorMapping(value = AttributeContentType.Codes.RESOURCE,
                        schema = ResourceObjectContent.class)},
        oneOf = {
