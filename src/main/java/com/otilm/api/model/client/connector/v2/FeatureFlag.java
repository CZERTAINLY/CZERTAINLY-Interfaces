...
public enum FeatureFlag implements IPlatformEnum {
    ...
    STATELESS("stateless", "Stateless", "A stateless connector does not require persistence layer (e.g. database)",
            FeatureFlagBehavior.INFORMATIONAL, null), OPEN_METRICS("openMetrics", "OpenMetrics",
                    "Metrics are exposed in OpenMetrics format", FeatureFlagBehavior.INFORMATIONAL,
                    List.of(ConnectorInterface.METRICS)), SECRET_VERSIONING("secretVersioning", "Secret Versioning",
                            "Supports versioning of secrets, allowing to keep track of history of secrets.",
                            FeatureFlagBehavior.ENFORCED, List.of(ConnectorInterface.SECRET)), SECRET_ROTATION(
                                    "secretRotation", "Secret Rotation", "Supports triggering rotation of secrets",
                                    FeatureFlagBehavior.ENFORCED, List.of(ConnectorInterface.SECRET)), CONTENT_SIGNING(
                                            "contentSigning", "Content Signing", "Supports content signing workflows",
                                            FeatureFlagBehavior.ENFORCED,
                                            List
                                                    .of(ConnectorInterface.SIGNING,
                                                            ConnectorInterface.SIGNATURE_FORMATTING)), TIMESTAMPING(
                                                                    "timestamping", "Timestamping",
                                                                    "Supports timestamping of signatures",
                                                                    FeatureFlagBehavior.ENFORCED,
                                                                    List
                                                                            .of(ConnectorInterface.SIGNING,
                                                                                    ConnectorInterface.SIGNATURE_FORMATTING)), CERTIFICATE_REGISTRATION(
                                                                                            ...
                                                                                            FeatureFlagBehavior.ENFORCED,
                                                                                            List
                                                                                                    .of(ConnectorInterface.AUTHORITY)), CERTIFICATE_STATUS_POLLING(
                                                                                                            ...
                                                                                                            FeatureFlagBehavior.ENFORCED,
                                                                                                            List
                                                                                                                    .of(ConnectorInterface.AUTHORITY)), CERTIFICATE_REQUEST_STRUCTURED(
                                                                                                                            "certificateRequestStructured",
                                                                                                                            "Structured Certificate Request",
                                                                                                                            ...
                                                                                                                            FeatureFlagBehavior.ENFORCED,
                                                                                                                            List
                                                                                                                                    .of(ConnectorInterface.AUTHORITY)), CERTIFICATE_IDENTITY_OVERRIDE(
                                                                                                                                            "certificateIdentityOverride",
                                                                                                                                            "Certificate Identity Override",
                                                                                                                                            ...
                                                                                                                                            FeatureFlagBehavior.ENFORCED,
                                                                                                                                            List
                                                                                                                                                    .of(ConnectorInterface.AUTHORITY)), DISCOVERY_STREAMING(
                                                                                                                                                            "discoveryStreaming",
                                                                                                                                                            "Discovery Streaming",
                                                                                                                                                            ...
                                                                                                                                                            FeatureFlagBehavior.ENFORCED,
                                                                                                                                                            List
                                                                                                                                                                    .of(ConnectorInterface.DISCOVERY)), DISCOVERY_STOP_RESUME(
                                                                                                                                                                            "discoveryStopResume",
                                                                                                                                                                            "Discovery Stop and Resume",
                                                                                                                                                                            "Supports pausing a running discovery with a resumable checkpoint and resuming it later",
                                                                                                                                                                            FeatureFlagBehavior.ENFORCED,
                                                                                                                                                                            List
                                                                                                                                                                                    .of(ConnectorInterface.DISCOVERY));
