...
@Schema(description = "Base Attribute definition", type = "object", discriminatorProperty = "type", discriminatorMapping = {
        ...
        @DiscriminatorMapping(value = AttributeType.Codes.CUSTOM, schema = CustomAttributeV3.class)}, oneOf = {
                DataAttributeV3.class, InfoAttributeV3.class, GroupAttributeV3.class, MetadataAttributeV3.class,
