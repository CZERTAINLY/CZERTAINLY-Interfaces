...
public class EntityInstanceApiClient extends BaseApiClient implements EntityInstanceSyncApiClient {
    ...
    private static final String ENTITY_INSTANCE_LOCATION_ATTRS_CONTEXT = ENTITY_INSTANCE_IDENTIFIED_CONTEXT
            + "/location/attributes";
    private static final String ENTITY_INSTANCE_LOCATION_ATTRS_VALIDATE_CONTEXT = ENTITY_INSTANCE_LOCATION_ATTRS_CONTEXT
            + "/validate";
