...
public class NotificationInstanceApiClient extends BaseApiClient implements NotificationInstanceSyncApiClient {
    ...
    private static final String NOTIFICATION_INSTANCE_IDENTIFIED_CONTEXT = NOTIFICATION_INSTANCE_BASE_CONTEXT
            + "/{uuid}";
    private static final String NOTIFICATION_INSTANCE_IDENTIFIED_SEND_CONTEXT = NOTIFICATION_INSTANCE_BASE_CONTEXT
            + "/{uuid}/notify";
    ...
    public List<NotificationProviderInstanceDto> listNotificationInstances(ApiClientConnectorInfo connector)
        ...
        return processRequest(r -> r
                .uri(connector.getUrl() + NOTIFICATION_INSTANCE_BASE_CONTEXT)
                .retrieve()
    ...
    public NotificationProviderInstanceDto getNotificationInstance(ApiClientConnectorInfo connector, String uuid)
        ...
        return processRequest(r -> r
                .uri(connector.getUrl() + NOTIFICATION_INSTANCE_IDENTIFIED_CONTEXT, uuid)
                .retrieve()
    ...
    public void sendNotification(ApiClientConnectorInfo connector, String uuid,
        ...
        processRequest(r -> r
                .uri(connector.getUrl() + NOTIFICATION_INSTANCE_IDENTIFIED_SEND_CONTEXT, uuid)
    ...
    public List<DataAttribute> listMappingAttributes(ApiClientConnectorInfo connector, String kind)
        ...
        return processRequest(r -> Objects
                .requireNonNull(r
                        .uri(connector.getUrl() + NOTIFICATION_INSTANCE_MAPPING_ATTRIBUTES_CONTEXT, kind)
                        .retrieve()
