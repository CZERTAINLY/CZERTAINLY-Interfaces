...
public interface TokenInstanceSyncApiClient {
    ...
    void validateTokenProfileAttributes(ConnectorDto connector, String uuid, List<RequestAttributeDto> attributes) throws ValidationException, ConnectorException;
    List<BaseAttribute> listTokenInstanceActivationAttributes(ConnectorDto connector, String uuid) throws ConnectorException;
    void validateTokenInstanceActivationAttributes(ConnectorDto connector, String uuid, List<RequestAttributeDto> attributes) throws ValidationException, ConnectorException;
    void activateTokenInstance(ConnectorDto connector, String uuid, List<RequestAttributeDto> attributes) throws ConnectorException;
