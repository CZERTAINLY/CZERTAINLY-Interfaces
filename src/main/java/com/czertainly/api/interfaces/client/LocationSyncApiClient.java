...
public interface LocationSyncApiClient {
    ...
    void validatePushCertificateAttributes(ConnectorDto connector, String entityUuid, List<RequestAttributeDto> pushAttributes) throws ConnectorException;
    ...
    void validateGenerateCsrAttributes(ConnectorDto connector, String entityUuid, List<RequestAttributeDto> pushAttributes) throws ConnectorException;
}
