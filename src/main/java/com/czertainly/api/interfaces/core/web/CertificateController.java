...
public interface CertificateController {
	...
	public List<CertificateEventHistoryDto> getCertificateActionHistory(@Parameter(description = "Certificate UUID") @PathVariable String uuid) throws NotFoundException;
