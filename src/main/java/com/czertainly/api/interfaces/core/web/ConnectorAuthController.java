...
public interface ConnectorAuthController extends AuthProtectedController {
	...
	List<BaseAttributeV2> getBasicAuthAttributes();
	...
	List<BaseAttributeV2> getCertificateAttributes();
	...
	List<BaseAttributeV2> getApiKeyAuthAttributes();
	...
	List<BaseAttributeV2> getJWTAuthAttributes();
