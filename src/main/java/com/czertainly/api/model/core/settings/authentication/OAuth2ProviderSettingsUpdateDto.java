...
public class OAuth2ProviderSettingsUpdateDto implements Serializable {
    ...
    @Schema(description = "Duration in seconds after which will inactive user's session be terminated.", defaultValue = "900", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
